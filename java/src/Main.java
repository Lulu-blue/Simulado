...
public class Main {
    ...
    private static int[] gerarDadosAleatorios(int tamanho) {
        ...
        for (int i = 0; i < tamanho; i++) {
            dados[i] = random.nextInt(100000) + 1;
        }
        return dados;
    }
    ...
    private static void testarHeapSortFilaPonteiro(int[] dados) {
        ...
        System.out.printf("Fila (ponteiro) %6d elementos: %.6f s%n", dados.length, tempoSegundos);
    }
    ...
    private static void testarHeapSortFilaVetor(int[] dados) {
        ...
        double tempoSegundos = (fim - inicio) / 1e9;
        System.out.printf("Fila (vetor)    %6d elementos: %.6f s%n", dados.length, tempoSegundos);
    }
    ...
    private static void testarHeapSortPilhaPonteiro(int[] dados) {
        ...
        double tempoSegundos = (fim - inicio) / 1e9;
        System.out.printf("Pilha (ponteiro)%6d elementos: %.6f s%n", dados.length, tempoSegundos);
    }
    ...
    private static void testarHeapSortPilhaVetor(int[] dados) {
        ...
        double tempoSegundos = (fim - inicio) / 1e9;
        System.out.printf("Pilha (vetor)   %6d elementos: %.6f s%n", dados.length, tempoSegundos);
    }
    ...
    private static void testarHeapSortListaPonteiro(int[] dados) {
        ...
        double tempoSegundos = (fim - inicio) / 1e9;
        System.out.printf("Lista (ponteiro)%6d elementos: %.6f s%n", dados.length, tempoSegundos);
    }
    ...
    private static void testarHeapSortListaVetor(int[] dados) {
        ...
        double tempoSegundos = (fim - inicio) / 1e9;
        System.out.printf("Lista (vetor)   %6d elementos: %.6f s%n", dados.length, tempoSegundos);
    }
}